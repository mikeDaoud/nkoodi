...
class ViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let vc5 = MoreViewController.create()
        ...
        option1.addAttribute(NSFontAttributeName, value: UIFont.init(name: "Chalkboard SE", size: 12), range: NSRange(location: 0, length: option1.length))
        ...
        option2.addAttribute(NSFontAttributeName, value: UIFont.init(name: "Chalkboard SE", size: 12), range: NSRange(location: 0, length: option2.length))
        ...
        option3.addAttribute(NSFontAttributeName, value: UIFont.init(name: "Chalkboard SE", size: 12), range: NSRange(location: 0, length: option3.length))
        ...
        option4.addAttribute(NSFontAttributeName, value: UIFont.init(name: "Chalkboard SE", size: 12), range: NSRange(location: 0, length: option4.length))
        ...
        option5.addAttribute(NSFontAttributeName, value: UIFont.init(name: "Chalkboard SE", size: 12), range: NSRange(location: 0, length: option5.length))
